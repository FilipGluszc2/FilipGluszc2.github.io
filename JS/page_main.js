	var i =0;
	var opacity = 0.2;
	var arrayImg = ["poe1.jpg", "poe2.jpg", "poe3.jpg", "poe4.jpg", "poe5.jpg", "poe6.jpg", "poe7.jpg"];
...
//function which make blur efect
	var img_opacity = () => {
		document.getElementById("frame").innerHTML = "<img class='img' style='opacity:"+opacity+"' src='../ZDJ/"+arrayImg[i]+"'>";
		opacity+=0.2;
	}
