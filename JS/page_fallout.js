	var i =0;
	var opacity = 0.2;
	var arrayImg = ["fallout1.jpg", "fallout2.jpg", "fallout3.jpg", "fallout4.jpg", "fallout5.jpg", "fallout6.jpg", "fallout7.jpg"];
...
//function which make blur efect
	var img_opacity = () => {
		document.getElementById("frame").innerHTML = "<img class='img' style='opacity:"+opacity+"' src='../ZDJ_fallout/"+arrayImg[i]+"'>";
		opacity+=0.2;
	}
