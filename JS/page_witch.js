	var i =0;
	var opacity = 0.2;
	var arrayImg = ["witch1.jpg", "witch2.jpg", "witch3.jpg", "witch4.jpg", "witch5.jpg", "witch6.jpg", "witch7.jpg"];
...
//function which make blur efect
	var img_opacity = () => {
		document.getElementById("frame").innerHTML = "<img class='img' style='opacity:"+opacity+"' src='../ZDJ_witch/"+arrayImg[i]+"'>";
		opacity+=0.2;
	}
