	var i =0;
	var opacity = 0.2;
	var arrayImg = ["wit1.jpg", "wit2.jpg", "wit3.jpg", "wit4.jpg", "wit5.jpg", "wit6.jpg", "wit7.jpg"];
...
//function which make blur efect
	var img_opacity = () => {
		document.getElementById("frame").innerHTML = "<img class='img' style='opacity:"+opacity+"' src='../ZDJ_wit3/"+arrayImg[i]+"'>";
		opacity+=0.2;
	}
