	var i =0;
	var opacity = 0.2;
	var arrayImg = ["dbl1.jpg", "dbl2.jpg", "dbl3.jpg", "dbl4.jpg", "dbl5.jpg", "dbl6.jpg", "dbl7.jpg"];
...
//function which make blur efect
	var img_opacity = () => {
		document.getElementById("frame").innerHTML = "<img class='img' style='opacity:"+opacity+"' src='../ZDJ_dbl3/"+arrayImg[i]+"'>";
		opacity+=0.2;
	}
